# ADHD: Kompleksowy Przewodnik 360°

**Polska książka o ADHD oparta na najnowszych badaniach naukowych**

## O Projekcie

Ta książka to kompleksowy przewodnik po ADHD (Attention-Deficit/Hyperactivity Disorder), łączący:
...
### Podejście
- Evidence-based (oparte na dowodach naukowych)
- Interdyscyplinarne
...
- Osoby z ADHD szukające kompleksowego zrozumienia swojego stanu
- Rodziny i partnerzy osób z ADHD
- Profesjonaliści pracujący z ADHD (psychologowie, psychiatrzy, coachowie)
- Każdy zainteresowany neurobiologią i optymalizacją poznawczą
...
### Eksperci
- Dr. Russell Barkley - światowy autorytet ADHD
- Dr. Edward Hallowell & Dr. John Ratey - "Driven to Distraction"
- Dr. Thomas Brown - model funkcji wykonawczych
- Dr. Ari Tuckman - praktyczne podejście
...
- Dr. Russell Barkley's lectures

## Struktura Repozytorium

```
adhd-complete-guide/
├── chapters/              # Rozdziały książki
│   ├── czesc-1-zrozumiec-adhd/
│   ├── czesc-2-leczenie-farmakologiczne/
│   ├── czesc-3-psychologia-i-terapia/
│   ├── czesc-4-praktyczne-strategie/
│   ├── czesc-5-biohacking-i-optymalizacja/
│   └── czesc-6-calosciowe-podejscie/
├── resources/             # Materiały dodatkowe
│   ├── bibliografia.md
│   ├── slowniczek.md
│   └── appendix/
├── README.md              # Ten plik
